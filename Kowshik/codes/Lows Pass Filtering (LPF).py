...
class LPFGui(tk.Tk):
    def __init__(self):
        ...
        self.btn_save = tk.Button(top, text="Save Filtered WAV…", command=self.save_filtered)
    ...
    def quick_plot_before(self):
        ...
        self.fig.colorbar(img1, ax=self.ax_spec_before, format="%+2.0f dB")
    ...
    def apply_and_plot(self):
        ...
        self.fig.colorbar(img2, ax=self.ax_spec_after, format="%+2.0f dB")
